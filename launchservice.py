...
""")
    ...
    for line in process.stdout:
        ...
        # Redémarrage de systemctl et lancement du service
    print("\033[33m[2/4]-Ajout du service a systemd.\033[0m")
    commands = "sudo systemctl daemon-reload && sudo systemctl enable remote_monitoring.service && sudo systemctl start remote_monitoring.service"
    ...
    if process.returncode != 0:
        ...
        print("\033[33m[3/4]-Génération du certificat.\033[0m")
        print(
        ...
        time.sleep(0.5)
        print("\n\033[33m[4/4]-Création du mot de passe.\033[0m")
        print(
